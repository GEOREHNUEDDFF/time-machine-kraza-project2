...
*/
    ...
    _.za = function (a) {
      return (
        (Object.prototype.hasOwnProperty.call(a, xb) && a[xb]) || (a[xb] = ++yb)
      );
    };
    ...
    Jd.prototype.add = function (a, b, c, d, e) {
      ...
      -1 < g
        ? ((b = a[g]), c || (b.Kd = !1))
        : ((b = new Hd(b, this.src, f, !!d, e)), (b.Kd = c), a.push(b));
      return b;
    };
    ...
    _.Xd = function (a, b, c, d, e) {
      if (Array.isArray(b))
        ...
        (d = _.ya(d) ? !!d.capture : !!d),
          ...
          _.Fd(a)
            ? a.rb(b, c, d, e)
            : a && (a = _.Td(a)) && (b = a.nd(b, c, d, e)) && _.Yd(b);
    };
    _.Yd = function (a) {
...
*/
      ...
      if (0 !== e.length) {
        ...
        a = (0, _.z)(this.B.H, this.B, _.wa(e), this.g, {
          ...
          Cf: function (f) {
            ...
            401 == f
              ? (gf(d, new ub.Xa(ub.Xa.g.tg, f)), (d.h.length = 0))
              : 410 == f
              ? (hf(d, new ub.Xa(ub.Xa.g.rg, f)), jf(d))
              : 3 <= d.D
              ? (hf(d, new ub.Xa(ub.Xa.g.hg, f)), jf(d))
              : d.M(d.o, !0, 8001 == f);
          },
    ...
    var ff = function (a, b) {
      ...
      $e = function (a) {
        a.j == a.F &&
          ((a.j = null),
          a.F.onLoad((0, _.z)(a.Pg, a)) && gf(a, new ub.Xa(ub.Xa.g.De)),
          bf(a));
      },
      na = function (a) {
        if (a.j) {
          ...
          a.pb() ||
            (a.g[b].onLoad((0, _.z)(a.Pg, a)) && gf(a, new ub.Xa(ub.Xa.g.De)),
            _.ua(a.A, b),
            _.ua(a.l, b),
            0 === a.l.length && jf(a),
    ...
    _.yf = function (a, b) {
      return xf(a.h, b)
        ? (delete a.h[b], --a.size, a.j++, a.g.length > 2 * a.size && vf(a), !0)
        : !1;
    };
    vf = function (a) {
    ...
    _.ng = function (a, b, c) {
      a.remove(b);
      0 < c.length &&
        ((a.j = null), a.g.set(lg(a, b), _.wa(c)), (a.h += c.length));
    };
    ...
    var oh = function (a, b, c, d, e) {
      ...
      ph = function (a, b, c, d, e) {
        ...
        for (
          var h = function (p, r) {
              for (
                var q = [], x = 0, D = Math.floor(p.length / r) + 1, Q = 0;
                Q < r;
                Q++
              ) {
                var U = (Q + 1) * D;
...
//# sourceURL=/_/translate_http/_/js/k=translate_http.tr.ar.yIUlHyWELrQ.O/d=1/rs=AN8SPfoQklxRsejBd8FRApEk5-eTdUphxg/m=el_conf
// Configure Constants
(function () {
  ...
  (function () {
    ...
    c._ps =
      "https://www.gstatic.com/_/translate_http/_/ss/k\x3dtranslate_http.tr.-MnnQo2KHRU.R.W.O/d\x3d0/rs\x3dAN8SPfpsBhRB4Od-Mf0SCZQGhCQsbwEl7A/m\x3del_main_css";
    c._plla = oph + "/v1/supportedLanguages";
    c._puh = "translate.google.com";
    c._cnal = {};
    _loadCss(c._ps);
    _loadJs(
      "https://translate.googleapis.com/_/translate_http/_/js/k\x3dtranslate_http.tr.ar.yIUlHyWELrQ.O/d\x3d1/exm\x3del_conf/ed\x3d1/rs\x3dAN8SPfoQklxRsejBd8FRApEk5-eTdUphxg/m\x3del_main"
    );
    _exportMessages();
    _exportVersion("TE_20230809");
  })();
})();

const outputDiv = document.getElementById("typing-container");
const txt = `🕀اهلا بك فى آلة الزمن للسفر إلى العهد القديم 🕀<nul>
 لتغيير اللغه <nul>
سوف  تجد فى كل صفحه ويب  <nul>
↖ على الناحيه اليمنى  <nul>
صندوق به جميع اللغات<nul>
اتمنى ان تستفيد بالمعلومات الموجوده<nul>
💪.--------------------------------------------.👌 <nul>
`;
const splitted = txt.split("<nul>");
...
function toggleDarkMode() {
  ...
  //save the theme preference to localstronge
  const isDrakModeEabled = document.body.classList.contains("darl-mode");
  localStorage.setItem("darkmode", isDrakModeEabled);
}
toggler.addEventListener("click", toggleDarkMode);
window.addEventListener("load", () => {
  //Retrive the theme preference from localstrong
